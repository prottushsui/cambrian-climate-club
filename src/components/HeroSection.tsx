      ...
      <div className="container mx-auto px-4 py-20 flex flex-col lg:flex-row items-center gap-12 relative z-10">
        ...
        >
          <p className="editorial-kicker mb-4">
            Cambrian School & College, Campus 2
          </p>
          <motion.h1
            id="hero-heading"
          ...
          >
            {titleWords.map((part, partIndex) => (
              <span
                key={partIndex}
                className={
                  partIndex > 0 ? 'block text-primary-700 mt-2' : 'block'
                }
              >
                {partIndex > 0 ? '— ' : ''}
                {part.map((word, wordIndex) => (
                  <span
                    key={wordIndex}
                    className="inline-block whitespace-nowrap mr-2 md:mr-4"
                  >
          ...
          >
            A student-led environmental initiative promoting sustainability,
            climate awareness, and community action since 2023.
          </motion.p>
          ...
          >
            <p className="text-lg font-semibold text-center text-primary-700">
              <strong>Mission:</strong> Empowering students to become proactive
              leaders in sustainability and climate action through hands-on
