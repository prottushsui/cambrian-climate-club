      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="grid md:grid-cols-3 gap-10 items-center">
            ...
            >
              <img
                ...
                className="h-40 w-auto object-contain drop-shadow-lg rounded-2xl"
              />
            </motion.div>
            <div className="md:col-span-2 space-y-6">
              ...
              >
                Founded in 2023 by a passionate group of over 20 students, the
                Cambrian Climate Club at Campus 2 was born from a shared desire
                to make a tangible difference in our immediate environment. We
                believe that meaningful change starts locally, and our mission
                is to empower students to become proactive leaders in
          ...
          <div className="mt-12">
            ...
            >
              <h3 className="text-2xl font-semibold text-charcoal-900 mb-8 text-center">
