...
const TimelineItem: React.FC<{ item: Achievement; index: number }> = ({
  item,
  index,
}) => (
  <motion.li
  ...
  >
    ...
    <div className="p-5 bg-white rounded-lg shadow-subtle hover:shadow-md transition-shadow border border-sandstone-200">
      <time className="mb-2 text-sm font-bold leading-none text-primary-700 block">
        {item.year}
      </time>
      <h3 className="text-base font-medium text-charcoal-800">
        {item.description}
      </h3>
    </div>
  </motion.li>
