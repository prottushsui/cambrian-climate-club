        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl">
              Get in touch with the Cambrian Climate Club.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">info@cambrianclimateclub.org</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">Cambrian School and College<br />Kuratoli, Dhaka 1229<br />Bangladesh</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                  ...
                  <div className="flex items-start">
                    <Globe className="h-6 w-6 text-green-600 mt-1 mr-3 flex-shrink-0" />
                    <div>
                      <h3 className="text-sm font-medium text-gray-900 dark:text-white">Website</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400">www.cambrianclimateclub.org</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white dark:bg-gray-800 shadow-lg">
                <CardHeader>
                  <CardTitle className="text-2xl text-gray-900 dark:text-white">Follow Us</CardTitle>
                </CardHeader>
                <CardContent>
