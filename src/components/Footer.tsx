        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse" aria-label="Cambrian Climate Club Home">
              <img src="https://imgur.com/a/aE3C0ia" className="h-10 w-auto" alt="Cambrian Climate Club Logo" />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600">
              ...
              <li className="flex items-center space-x-3">
                 <svg className="w-5 h-5 text-blue-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                 <a href="mailto:info@cambrianclimateclub.com" className="hover:text-blue-600 transition-colors">info@cambrianclimateclub.com</a>
              </li>
            </ul>
          </div>
