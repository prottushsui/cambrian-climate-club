...
const SocialLink: React.FC<{ href: string; label: string; path: string }> = ({ href, label, path }) => (
    <motion.a 
        ...
        className="text-charcoal-500 hover:text-primary-700 transition-colors block"
        aria-label={label}
        whileHover={{ scale: 1.15, color: '#0B1B2B' }}
        whileTap={{ scale: 0.95 }}
...
const FooterLink: React.FC<{ to: string; children: React.ReactNode }> = ({ to, children }) => (
    <motion.li 
        ...
        transition={{ type: "spring", stiffness: 300, damping: 20 }}
    >
        <Link to={to} className="hover:text-primary-700 transition-colors flex items-center text-sm">
            <span className="w-1.5 h-1.5 bg-coral-400 rounded-full mr-2 opacity-0 hover:opacity-100 transition-opacity"></span>
            {children}
        </Link>
    </motion.li>
);
...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-sandstone-100 border-t border-sandstone-200 pt-16 pb-8">
      <div className="max-w-screen-xl mx-auto p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse" aria-label="Cambrian Climate Club Home">
              ...
              <span className="self-center text-lg font-semibold whitespace-nowrap text-charcoal-900">Cambrian Climate Club</span>
            </Link>
          ...
          <div>
            <h3 className="text-charcoal-900 font-semibold mb-4 uppercase text-xs tracking-[0.2em]">Quick Links</h3>
          ...
          <div>
            <h3 className="text-charcoal-900 font-semibold mb-4 uppercase text-xs tracking-[0.2em]">Contact Us</h3>
            <ul className="space-y-3 text-sm text-charcoal-600">
              <li className="flex items-start space-x-3">
                 <svg className="w-5 h-5 text-primary-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                 <span className="leading-relaxed">Cambrian School & College, Campus 2<br/>Dhaka, Bangladesh</span>
              </li>
              <li className="flex items-center space-x-3">
                 <svg className="w-5 h-5 text-primary-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                 <a href="mailto:info@cambrianclimateclub.com" className="hover:text-primary-700 transition-colors">info@cambrianclimateclub.com</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-charcoal-900 font-semibold mb-4 uppercase text-xs tracking-[0.2em]">Follow Us</h3>
        ...
        <hr className="my-8 border-sandstone-200" />
