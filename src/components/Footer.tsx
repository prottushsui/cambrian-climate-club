...
const FooterLink: React.FC<{ to: string; children: React.ReactNode }> = ({ to, children }) => (
    <motion.li 
        ...
        transition={{ type: "spring", stiffness: 300, damping: 20 }}
    >
        <Link to={to} className="hover:text-primary transition-colors flex items-center text-sm text-foreground">
...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-sandstone-100 border-t border-border pt-16 pb-8">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          
          {/* Column 1: Brand & About */}
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-3" aria-label="Cambrian Climate Club Home">
          ...
          <div>
            <h3 className="text-foreground font-semibold mb-4 uppercase text-xs tracking-wider">Quick Links</h3>
          ...
          <div>
            <h3 className="text-foreground font-semibold mb-4 uppercase text-xs tracking-wider">Contact Us</h3>
            <ul className="space-y-3 text-sm text-foreground">
              ...
              <li className="flex items-center space-x-3">
                 ...
                 <a href="mailto:info@cambrianclimateclub.com" className="hover:text-primary transition-colors">info@cambrianclimateclub.com</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-foreground font-semibold mb-4 uppercase text-xs tracking-wider">Follow Us</h3>
            <p className="text-foreground text-sm mb-4">Stay connected with our latest updates, events, and environmental tips.</p>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-foreground sm:text-center">© {currentYear} Cambrian Climate Club. All Rights Reserved.</span>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
             <Link to="#" className="text-sm text-foreground hover:text-primary transition-colors">Privacy Policy</Link>
             <Link to="#" className="text-sm text-foreground hover:text-primary transition-colors">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
